...
def _GetJsonBenchmarkList(possible_browser, possible_reference_browser,
  ...
  for benchmark_class in benchmark_classes:
    ...
    # is minimized.
    hash_shift = {
      2 : 47,  # for old desktop configurations with 2 subordinates
      5 : 56,  # for new desktop configurations with 5 subordinates
      21 : 43  # for Android 3 subordinates 7 devices configurations
    }
